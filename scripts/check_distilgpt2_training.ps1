...
$artifactDir = Join-Path $repoRoot "artifacts\distilgpt2-copilot-sre-lora"

Write-Host "==> WSL process"
wsl -d Ubuntu-24.04 -- bash -lc "ps -ef | grep distilgpt2-base | grep train_lora.py | grep -v grep || true"
